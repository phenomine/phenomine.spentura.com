...
<nav class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:bg-gray-950 dark:border-gray-900">
    <div class="max-w-screen-xxl flex flex-wrap items-center justify-between mx-auto p-4 lg:pl-10 lg:pr-10">
        <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" class="p-2 mr-2 text-gray-500 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-900 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-800 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-white">
            <svg id="toggleSidebarMobileHamburger" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
            <svg id="toggleSidebarMobileClose" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </button>
        <div class="flex items-center space-x-3 rtl:space-x-reverse">
            <a n:navigate="route('index')" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{asset('build/images/phenomine_logo.svg')}" class="h-5 lg:h-8" alt="Phenomine Logo" />
                <span class="self-center text-lg lg:text-2xl font-semibold whitespace-nowrap dark:text-white">Phenomine</span>
            </a>
            <button id="dropdown-version" data-dropdown-toggle="dropdown" class="text-gray-700 dark:text-gray-100 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 focus:ring focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-600 font-medium rounded-full text-sm px-3 py-1 lg:px-5 lg:py-2.5 text-center inline-flex items-center" type="button">
                3.x
        ...
        <div class="flex md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
            <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:ring focus:ring-gray-200 dark:focus:ring-gray-800 rounded-lg text-sm p-2.5">
